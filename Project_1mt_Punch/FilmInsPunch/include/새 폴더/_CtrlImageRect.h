...
protected:
	...
	int m_iGray;
	int m_iCamIndex;
	BOOL	m_bIsFitToLongSide;	//	20191028 bjs Fit 기준을 긴쪽, 짧은쪽 선택할 수 있도록 함
...
public:
	...
	//Zoom
	void SetFitType(BOOL bFitToLongSide);	//	20191028 bjs Fit 기준을 긴쪽, 짧은쪽 선택할 수 있도록 함
	void SetZoom(double zoom, long width, long height);
